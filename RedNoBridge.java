...
@Autonomous
public class RedNoBridge extends LinearOpMode {
      ...
      // sleep(300);
       ...
       sleep(300);
        ...
        public void RightAutonomous()
        {
            ...
            sleep(100);
            ResetEncoders();
            DriveRight(1200,2000, 1300);
            StopDriving();
            sleep(200);
            ResetEncoders();
            TurnLeft(930,700, 1500);
            StopDriving();
            sleep(300);
        ...
        public void CenterAutonomous()
        {
            ...
            sleep(100);
            ResetEncoders();
            DriveRight(1200,2000, 1500);
            StopDriving();
            sleep(200);
            ResetEncoders();
            TurnLeft(900,700, 1500);
            StopDriving();
            sleep(300);
            flip.setPosition(0.1);
            open.setPosition(0.06);
